<?php $__env->startSection('meta:title', 'Examples - One Laravel Framework'); ?>
<?php $__env->startSection('meta:description', 'Interactive examples and demos showcasing One Laravel features - from simple counters to complex applications.'); ?>
<?php $__env->startSection('meta:keywords', 'One Laravel examples, Laravel SPA demos, reactive components examples'); ?>
...
<pre><code class="syntax-highlight"><?php // Invalid @useState directive: @useState(['count' => 0]) ?>

&lt;div class="counter-component"&gt;
    &lt;h4&gt;Count: <?php echo e(count); ?>&lt;/h4&gt;
    &lt;div class="btn-group"&gt;
                ...
                <div class="col-lg-6 mb-4" data-category="basic forms">
                    <div class="example-card">
                        ...
                        <div class="example-code">
                            ...
                            <div class="code-content">
                                <div class="code-block active" data-lang="blade">
<pre><code class="syntax-highlight"><?php // Invalid @useState directive: @useState(['todos' => [], 'newTodo' => '']) ?>
...
&lt;div class="todo-app"&gt;
    ...
    &lt;ul&gt;
        <?php $__currentLoopData = $todos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $todo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            &lt;li class="<?php echo e($todo['completed'] ? 'completed' : ''); ?>"&gt;
                &lt;input type="checkbox" 
                       data-change="toggleTodo(<?php echo e($index); ?>)"
                       <?php echo e($todo['completed'] ? 'checked' : ''); ?>&gt;
                <?php echo e($todo['text']); ?>

                &lt;button data-click="deleteTodo(<?php echo e($index); ?>)"&gt;×&lt;/button&gt;
            &lt;/li&gt;
                ...
                <div class="col-lg-6 mb-4" data-category="api advanced">
                    <div class="example-card">
                        ...
                        <div class="example-code">
                            ...
                            <div class="code-content">
                                <div class="code-block active" data-lang="blade">
<pre><code class="syntax-highlight"><?php // Invalid @useState directive: @useState([
    'users' => [],
    'loading' => false,
    'error' => null
]) ?>
        ...
        &lt;div class="users-grid"&gt;
            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                &lt;div class="user-card"&gt;
                    ...
                    &lt;small&gt;<?php echo e($user['company']['name']); ?>&lt;/small&gt;
                &lt;/div&gt;
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        &lt;/div&gt;
    <?php endif; ?>
...
<pre><code class="syntax-highlight"><?php // Invalid @useState directive: @useState([
    'messages' => [],
    'newMessage' => '',
    'currentUser' => 'User' . rand(1000, 9999),
    'connected' => false,
    'typing' => false
]) ?>
...
&lt;div class="chat-app"&gt;
    &lt;div class="chat-header"&gt;
        &lt;h5&gt;Chat Room&lt;/h5&gt;
        &lt;div class="status <?php echo e($connected ? 'online' : 'offline'); ?>"&gt;
            <?php echo e($connected ? 'Connected' : 'Disconnected'); ?>
    ...
    &lt;div class="messages-container"&gt;
        <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            &lt;div class="message <?php echo e($message['user'] === $currentUser ? 'sent' : 'received'); ?>"&gt;
                &lt;div class="message-author"&gt;<?php echo e($message['user']); ?>&lt;/div&gt;
                &lt;div class="message-text"&gt;<?php echo e($message['text']); ?>&lt;/div&gt;
                &lt;div class="message-time"&gt;<?php echo e($message['timestamp']); ?>&lt;/div&gt;
            &lt;/div&gt;
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    &lt;/div&gt;
    ...
    public function sendMessage(Request $request)
    {
        ...
        <div class="text-center mt-5">
            <div class="cta-section">
                ...
                <div class="btn-group">
                    <a href="<?php echo e(url('/docs')); ?>" class="btn btn-primary" data-navigate="/web/docs">
                        View Documentation
                    </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/doanln/Desktop/2025/Projects/onelaravel/resources/views/web/examples.blade.php ENDPATH**/ ?>
...
@section('meta:title', 'Contact - One Laravel Framework')
@section('meta:description', 'Get in touch with the One Laravel team - Support, contributions, and community resources.')
@section('meta:keywords', 'One Laravel contact, support, community, contributions, help')
                        ...
                        <div class="faq-list">
                            <div class="faq-item">
                                ...
                                <div class="faq-answer" id="faq-1">
                                    <p>Getting started is easy! Install One Laravel via Composer with <code>composer create-project one-laravel/laravel my-app</code>, then follow our <a href="{{ url('/docs') }}" data-navigate="/web/docs">quick start guide</a>.</p>
                                </div>
                            </div>

...
@section('meta:title', 'About One Laravel - Advanced SPA Framework')
@section('meta:description', 'Learn about One Laravel, the innovative framework that bridges Laravel backend with modern SPA frontend capabilities.')
@section('meta:keywords', 'About One Laravel, Laravel SPA, Framework History, Team, Mission')
...
<section class="py-5">
    <div class="container">
        ...
        <div class="text-center mt-5">
            <a href="{{ url('/docs') }}" class="btn btn-outline" data-navigate="/web/docs">
...
<section class="py-5" style="background: var(--gradient-primary); color: white;">
    <div class="container">
        ...
        <div class="text-center mt-4">
            <a href="{{ url('/contact') }}" class="btn btn-secondary" data-navigate="/web/contact">
                Share Your Ideas
            </a>
        </div>
    </div>

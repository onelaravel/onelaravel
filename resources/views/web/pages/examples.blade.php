...
@section('meta:title', 'Examples - One Laravel Framework')
@section('meta:description', 'Interactive examples and demos showcasing One Laravel features - from simple counters to complex applications.')
@section('meta:keywords', 'One Laravel examples, Laravel SPA demos, reactive components examples')
...
<pre><code class="syntax-highlight">@useState(['count' => 0])
                ...
                <div class="col-lg-6 mb-4" data-category="basic forms">
                    <div class="example-card">
                        ...
                        <div class="example-code">
                            ...
                            <div class="code-content">
                                <div class="code-block active" data-lang="blade">
<pre><code class="syntax-highlight">@useState(['todos' => [], 'newTodo' => ''])
    ...
    &lt;ul&gt;
        @foreach($todos as $index => $todo)
            &lt;li class="{{ $todo['completed'] ? 'completed' : '' }}"&gt;
                &lt;input type="checkbox" 
                       data-change="toggleTodo({{ $index }})"
                       {{ $todo['completed'] ? 'checked' : '' }}&gt;
                {{ $todo['text'] }}
                &lt;button data-click="deleteTodo({{ $index }})"&gt;×&lt;/button&gt;
            &lt;/li&gt;
        @endforeach
    &lt;/ul&gt;
&lt;/div&gt;</code></pre>
                ...
                <div class="col-lg-6 mb-4" data-category="api advanced">
                    <div class="example-card">
                        ...
                        <div class="example-code">
                            ...
                            <div class="code-content">
                                <div class="code-block active" data-lang="blade">
<pre><code class="syntax-highlight">@useState([
    'users' => [],
    'loading' => false,
    'error' => null
])
...
&lt;div class="chat-app"&gt;
    ...
    &lt;div class="messages-container"&gt;
        @foreach($messages as $message)
            &lt;div class="message {{ $message['user'] === $currentUser ? 'sent' : 'received' }}"&gt;
    ...
    public function sendMessage(Request $request)
    {
        ...
        <div class="text-center mt-5">
            <div class="cta-section">
                ...
                <div class="btn-group">
                    <a href="{{ url('/docs') }}" class="btn btn-primary" data-navigate="/web/docs">
                        View Documentation
                    </a>

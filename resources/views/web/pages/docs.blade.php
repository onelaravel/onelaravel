...
@section('meta:title', 'Documentation - One Laravel Framework')
@section('meta:description', 'Complete documentation for One Laravel - Learn how to build reactive SPAs with Laravel and Blade templates.')
@section('meta:keywords', 'One Laravel docs, Laravel SPA documentation, Blade reactive components')

...
@section('meta:title', 'One Laravel - Advanced SPA Framework')
@section('meta:description', 'One Laravel combines Laravel\'s powerful backend with modern SPA capabilities for lightning-fast, reactive web applications.')
@section('meta:keywords', 'Laravel, SPA, PHP, JavaScript, Framework, Reactive, One Laravel, Web Development')
...
<section class="hero">
    <div class="container">
        ...
        <div class="hero-actions" style="margin-top: 2rem;">
            <a href="{{ url('/docs') }}" class="btn btn-large" data-navigate="/web/docs">Get Started</a>
            <a href="{{ url('/examples') }}" class="btn btn-secondary btn-large" data-navigate="/web/examples">View Examples</a>
        </div>
...
<pre><code class="syntax-highlight">{{-- resources/views/components/todo-app.blade.php --}}
@verbatim
...
@endverbatim
        ...
        <div class="text-center mt-4">
            <a href="{{ url('/examples') }}" class="btn btn-outline" data-navigate="/web/examples">
                View More Examples →
            </a>
        </div>
    </div>
...
php artisan serve</code></pre>
        ...
        <a href="{{ url('/docs') }}" class="btn btn-secondary btn-large" data-navigate="/web/docs">
